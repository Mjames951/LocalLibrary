...
def author_delete(request, pk):
    ...
    try:
        ...
        messages.success(request, (author.first_name + ' ' +
        author.last_name + ' cannot be deleted. Books exist for this author'))
...
def book_delete(request, pk):
    ...
    try:
        book.delete()
        messages.success(request, (f"{book.title} by {book.author} has been deleted."))
    except:
        messages.success(request, (f"{book.title} by {book.author} cannot be deleted, a book instance exists for this book."))
